...
my_assistant = client.beta.assistants.create(
	...
	instructions="""You are an interior design expert in Singapore. 
		Conduct research online to answer questions.
		Do not include links in your final research.""",
	model="gpt-4",
	tools=tools_list
)
...
while True:
	...
	run_status = client.beta.threads.runs.retrieve(thread_id=empty_thread.id, run_id=run.id)
